...
if(@$_POST['nlpayment']) {
	...
	$total_amount=$_POST['total_amount'];
	 ...
	 $array_items[0]= array('item_name1' => 'Thanh',
					 'item_quantity1' => 1,
	...
	<form  name="NLpayBank" action="#" method="post">	
		<table style="clear:both;width:500px;padding-left:46px;"> 
			...
			<tr><td>Số tiền thanh toán: </td>
				<td>
					 <input type="text" style="width:270px" id="total_amount" name="total_amount" class="field-check " value="<?php echo $_POST['product'] ?>">
				</td>
			</tr>
			<tr><td>Họ Tên: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_fullname" class="field-check " value="<?php echo $_POST['buyer_fullname']?>">
				</td>
			</tr>
			<tr><td>Email: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_email" class="field-check " value="<?php echo $_POST['buyer_email'] ?>">
				</td>
			</tr>
			<tr><td>Số Điện thoại: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_mobile" class="field-check " value="<?php echo $_POST['Phone1'] ?>">
				</td>
			</tr>				
		</table>	
