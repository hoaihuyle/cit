...
$('document').ready(function(){
    ...
    $('.add_work').click(function(){
            ...
            input1 = ' <div class="ct_father row"><div class="col-md-4"> <div class="Work_ip"> <select class="custom-select jobFilter" name="job">' + input + ' </select> </div> </div><div class="col-md-1"><div class="icheck-material-indigo Work_per"><input type="checkbox" checked id="thoathuan" /><label for="thoathuan"></label></div></div> <div class="col-md-6"> <div class="cate_per"><input type="number" class="form-control" style="width: 50%" placeholder="100,000"><select class="form-control" style="width: 45%" name="" id=""><option value="">VND/Giờ</option> </select></div></div> <div class="col-md-1 del_work"><a><img src="/admin/images/close.svg" alt=""> </a></div></div>'
    ...
    $(document).on('click','.ct_work .ct_father .del_work',function(){
        var quatati = $('.ct_work').find('.ct_father').length;
        console.log(quatati)
